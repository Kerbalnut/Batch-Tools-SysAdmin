...
::===============================================================================
:: Phase 1: Test :GetIfPathIsDriveRoot
:: Phase 2: Test :GetWindowsVersion
:: Phase 3: Test Banner.cmd (external function)
:: Phase 4: Test :GetTerminalWidth
:: Phase 5: Test :CheckLink
:: Phase 6: Test :GetDate, :ConvertTimeToSeconds, and :ConvertSecondsToTime
:: Phase 7: Test :InitLog and :InitLogOriginal
:: Phase 8: Test :CreateShortcut, :CreateSymbolicLink, and :CreateSymbolicDirLink
::===============================================================================
