...
::NSLOOKUP "%_REMOTE_HOST%" >nul 2>&1 && SET "_COMMAND_EXIT=SUCCESS" || SET "_COMMAND_EXIT=FAILURE"
NSLOOKUP "%_REMOTE_HOST%" >nul 2>"%_ERROR_OUTPUT_FILE%"

SET "_ERROR_STRING=can't find"
::FINDSTR /C:"%_ERROR_STRING%" "%_ERROR_OUTPUT_FILE%"
