...
SET "_LocalFolderPath=%~dp0" & REM : Drive letter and folder path local to this script's location.
SET "_LocalFileName=%~n0.txt" & REM : This scripts name with a .txt extension.
